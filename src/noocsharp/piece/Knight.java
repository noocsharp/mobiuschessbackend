...
public class Knight extends Piece{
    ...
    public HashSet<Tuple<Integer, Integer>> getInfluence(ArrayList<Piece> pieces, int width, int height) {
        ...
        Tuple<Integer, Integer> ur1 = new Tuple<>(this.pos.x+2, (this.pos.y+1+height)%height);
        Tuple<Integer, Integer> ul1 = new Tuple<>(this.pos.x-2, (this.pos.y+1+height)%height);
        Tuple<Integer, Integer> dl1 = new Tuple<>(this.pos.x-2, (this.pos.y-1+height)%height);
        Tuple<Integer, Integer> dr1 = new Tuple<>(this.pos.x+2, (this.pos.y-1+height)%height);

        Tuple<Integer, Integer> ur2 = new Tuple<>(this.pos.x+1, (this.pos.y+2+height)%height);
        Tuple<Integer, Integer> ul2 = new Tuple<>(this.pos.x+1, (this.pos.y-2+height)%height);
        Tuple<Integer, Integer> dl2 = new Tuple<>(this.pos.x-1, (this.pos.y-2+height)%height);
        Tuple<Integer, Integer> dr2 = new Tuple<>(this.pos.x-1, (this.pos.y+2+height)%height);
